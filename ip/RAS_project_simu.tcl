...
#
# Generated by Vivado on Tue Apr 13 14:31:45 +0200 2021
...
set obj [get_filesets sources_1]
set files [list \
 [file normalize "${origin_dir}/fifo_pipeout/fifo_pipeout.xci"] \
]
add_files -norecurse -fileset $obj $files

# Set 'sources_1' fileset file properties for remote files
set file "$origin_dir/fifo_pipeout/fifo_pipeout.xci"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
...
set obj [get_filesets sources_1]
set files [list \
 [file normalize "${origin_dir}/fifo_pipein/fifo_pipein.xci"] \
]
add_files -norecurse -fileset $obj $files

# Set 'sources_1' fileset file properties for remote files
set file "$origin_dir/fifo_pipein/fifo_pipein.xci"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "generate_files_for_reference" -value "0" -objects $file_obj
set_property -name "registered_with_manager" -value "1" -objects $file_obj
...
set obj [get_filesets sources_1]
set files [list \
 [file normalize "${origin_dir}/fifoHK_pipeout/fifoHK_pipeout.xci"] \
]
add_files -norecurse -fileset $obj $files

# Set 'sources_1' fileset file properties for remote files
set file "$origin_dir/fifoHK_pipeout/fifoHK_pipeout.xci"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "generate_files_for_reference" -value "0" -objects $file_obj
set_property -name "registered_with_manager" -value "1" -objects $file_obj
