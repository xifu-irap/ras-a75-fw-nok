...
#set_property IOSTANDARD LVCMOS33 [get_ports {}]
## MC1-65
set_property PACKAGE_PIN AB1 [get_ports {o_dac_sync_cluster_high_n}]
set_property IOSTANDARD LVCMOS33 [get_ports {o_dac_sync_cluster_high_n}]
## MC1-66
...
set_property PACKAGE_PIN V9 [get_ports o_sig_overlap1]
set_property PACKAGE_PIN Y9 [get_ports o_sig_overlap2]
set_property PACKAGE_PIN V8 [get_ports o_sig_overlap3]
set_property PACKAGE_PIN R6 [get_ports o_sig_overlap4]
set_property PACKAGE_PIN V7 [get_ports o_sig_overlap5]
set_property PACKAGE_PIN T6 [get_ports o_sig_overlap6]
set_property PACKAGE_PIN W7 [get_ports o_sig_overlap7]
set_property PACKAGE_PIN U6 [get_ports o_sig_overlap8]
set_property PACKAGE_PIN Y8 [get_ports o_sig_overlap9]
set_property PACKAGE_PIN V5 [get_ports o_sig_overlap10]
set_property PACKAGE_PIN Y7 [get_ports o_sig_overlap11]
set_property PACKAGE_PIN T5 [get_ports o_sig_overlap12]
#set_property IOSTANDARD LVCMOS33 [get_ports i_clk]
#set_property PACKAGE_PIN Y11 [get_ports i_clk]
