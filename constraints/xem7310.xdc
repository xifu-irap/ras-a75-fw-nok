...
set_property PACKAGE_PIN U6 [get_ports o_sig_overlap7]
set_property PACKAGE_PIN Y8 [get_ports o_sig_overlap8]
set_property PACKAGE_PIN V5 [get_ports o_sig_overlap9]
set_property PACKAGE_PIN Y7 [get_ports o_sig_overlap10]
set_property PACKAGE_PIN T5 [get_ports o_sig_overlap11]
