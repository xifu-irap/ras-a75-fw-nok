...
#
# Generated by export_simulation on Wed Jan 05 12:37:52 +0100 2022
#
################################################################################
...
'-reset_run' switch to the './fifoHK_pipeout.sh' script.

./fifoHK_pipeout.sh -reset_run
...
./fifoHK_pipeout.sh -noclean_files

For more information on the script, please type './fifoHK_pipeout.sh -help'.
