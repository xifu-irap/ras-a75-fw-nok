...
#
# Generated by export_simulation on Wed Jan 05 12:37:55 +0100 2022
#
################################################################################
...
'-reset_run' switch to the './fifo_pipein.sh' script.

./fifo_pipein.sh -reset_run
...
./fifo_pipein.sh -noclean_files

For more information on the script, please type './fifo_pipein.sh -help'.
