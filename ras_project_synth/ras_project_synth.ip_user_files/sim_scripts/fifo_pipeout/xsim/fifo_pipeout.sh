...
#
# Generated by Vivado on Wed Jan 05 12:37:50 +0100 2022
# SW Build 3064766 on Wed Nov 18 09:12:45 MST 2020
#
# Copyright 1986-2020 Xilinx, Inc. All Rights Reserved. 
#
# usage: fifo_pipeout.sh [-help]
# usage: fifo_pipeout.sh [-lib_map_path]
# usage: fifo_pipeout.sh [-noclean_files]
# usage: fifo_pipeout.sh [-reset_run]
#
#*********************************************************************************************************
...
# Script info
echo -e "fifo_pipeout.sh - Script generated by export_simulation (Vivado v2020.2 (64-bit)-id)\n"
...
elaborate()
{
  xelab --relax --debug typical --mt auto -L fifo_generator_v13_2_5 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot fifo_pipeout xil_defaultlib.fifo_pipeout xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim fifo_pipeout -key {Behavioral:sim_1:Functional:fifo_pipeout} -tclbatch cmd.tcl -log simulate.log
}
...
setup()
{
  case $1 in
    "-lib_map_path" )
      if [[ ($2 == "") ]]; then
        echo -e "ERROR: Simulation library directory path not specified (type \"./fifo_pipeout.sh -help\" for more information)\n"
        exit 1
      fi
     copy_setup_file $2
    ;;
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb fifo_pipeout.wdb xsim.dir)
...
check_args()
{
  if [[ ($1 == 1 ) && ($2 != "-lib_map_path" && $2 != "-noclean_files" && $2 != "-reset_run" && $2 != "-help" && $2 != "-h") ]]; then
    echo -e "ERROR: Unknown option specified '$2' (type \"./fifo_pipeout.sh -help\" for more information)\n"
    exit 1
  fi
...
usage()
{
  msg="Usage: fifo_pipeout.sh [-help]\n\
Usage: fifo_pipeout.sh [-lib_map_path]\n\
Usage: fifo_pipeout.sh [-reset_run]\n\
Usage: fifo_pipeout.sh [-noclean_files]\n\n\
