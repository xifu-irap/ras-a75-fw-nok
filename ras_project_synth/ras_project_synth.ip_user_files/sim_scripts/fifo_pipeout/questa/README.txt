...
#
# Generated by export_simulation on Wed Jan 05 12:37:50 +0100 2022
#
################################################################################
...
'-reset_run' switch to the './fifo_pipeout.sh' script.

./fifo_pipeout.sh -reset_run
...
./fifo_pipeout.sh -noclean_files

For more information on the script, please type './fifo_pipeout.sh -help'.
