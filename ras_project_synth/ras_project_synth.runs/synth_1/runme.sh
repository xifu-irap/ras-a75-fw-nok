...
HD_PWD='C:/Users/paulm/OneDrive/Bureau/ras-a75-fw-1.3.0/ras-a75-fw-1.3.0/ras_project_synth/ras_project_synth.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log row_addressing.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source row_addressing.tcl
