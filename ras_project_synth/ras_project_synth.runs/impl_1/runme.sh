...
HD_PWD='C:/Users/paulm/OneDrive/Bureau/ras-a75-fw-1.3.0/ras-a75-fw-1.3.0/ras_project_synth/ras_project_synth.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log row_addressing.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source row_addressing.tcl -notrace
